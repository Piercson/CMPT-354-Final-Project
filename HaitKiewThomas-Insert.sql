...
(DEFAULT,10,30,'submitted',17500, 0),
...
(DEFAULT,13,7,'submitted',2000, 0),
(DEFAULT,13,8,'submitted',10000, 0),
(DEFAULT,13,9,'submitted',8000, 0),
(DEFAULT,14,10,'awarded',10000, 21500),
(DEFAULT,14,11,'submitted',15000, 0),
(DEFAULT,14,12,'denied',30000, 0),
(DEFAULT,15,13,'awarded',40000, 30000),
(DEFAULT,15,14,'awarded',10000, 10000),
(DEFAULT,15,15,'denied',40000, 0),
(DEFAULT,16,16,'awarded',36000, 30000),
(DEFAULT,16,17,'awarded',50000, 45000),
(DEFAULT,16,18,'denied',50000, 0);
